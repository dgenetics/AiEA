...
- `lanes-persist` accepted work renders in its lane column on the Tasks board.
...
- **Select Current.** Click `Current`, then Accept. Land on `/tasks`; the card is in the Current column. Capture `board-lanes-board.png`.
