  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end justify-center md:items-center md:p-4">
      <button
        ...
        onClick={onClose}
      />
      <div className="relative max-h-[92dvh] w-full max-w-md overflow-y-auto rounded-t-2xl border border-white/10 bg-zinc-950 p-4 shadow-2xl safe-bottom md:max-h-[90vh] md:rounded-2xl md:p-5">
